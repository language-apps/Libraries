...
/*
 * 1/12/20 : new Long, Integer - they are deprecated
 */
...
public class DecodedMpegAudioInputStream extends TAsynchronousFilteredAudioInputStream implements PropertiesContainer, TagParseListener
{
	...
	public Map<String, Object> properties()
	{
		...
		properties.put("mp3.frame.bitrate", (int)(currentBitrate));
		properties.put("mp3.frame.size.bytes", (int)(currentFramesize));
